...
const INSTRUCTIONS = `You are a specialized job-search agent. Your goal: persist up to ${SCOUT_MAX_MATCHES} LinkedIn offers that genuinely fit the user's profile, evaluating up to ${SCOUT_MAX_CANDIDATES} candidates per session.
